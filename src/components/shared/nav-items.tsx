...
export const WMS_NAV_ITEMS: NavItem[] = [
  ...
  { title: 'sidebar.goodsReceipt', titleFallback: 'Mal Kabul', icon: operationsIcon, children: [
    ...
    { title: 'sidebar.incomingInvoices', titleFallback: 'Gelen e-Fatura / e-Arşiv', href: '/warehouse/incoming-invoices', searchAliases: ['e-fatura', 'e-arşiv', 'fatura', 'ubl', 'pdf', 'uuid'], requiredPermission: 'WMS.INCOMING_INVOICE.VIEW' },
    { title: 'sidebar.eLogoConnections', titleFallback: 'eLogo Bağlantıları', href: '/warehouse/incoming-invoices/connections', searchAliases: ['elogo', 'fatura', 'bağlantı', 'entegratör'], requiredPermission: 'WMS.INCOMING_INVOICE.CONNECTIONS.MANAGE' },

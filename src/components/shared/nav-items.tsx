...
export const WMS_NAV_ITEMS: NavItem[] = [
  ...
  { title: 'sidebar.kkd', titleFallback: 'KKD', icon: kkdIcon, children: [
    ...
    { title: 'sidebar.kkdDefinitions', titleFallback: 'KKD Tanımları', href: '/warehouse/kkd/definitions', searchAliases: ['kkd', 'departman', 'rol', 'personel', 'hak', 'matris', 'tanımlar'], requiredPermission: 'WMS.KKD.DEFINITIONS.VIEW' },

...
export function ThemeDayNightSwitch({
  checked,
  onCheckedChange,
  disabled,
  ...
  const toggleId = `theme-day-night-${reactId}`;
  const filterContainerId = `${toggleId}-container`;
  const filterSunOuterId = `${toggleId}-sun-outer`;
  const filterSunId = `${toggleId}-sun`;
  const filterMoonId = `${toggleId}-moon`;
  const filterCloudId = `${toggleId}-cloud`;
  ...
  return (
    <label
      htmlFor={toggleId}
      className={cn(
        'wms-theme-day-night-switch',
        disabled && 'wms-theme-day-night-switch--disabled',
      )}
      aria-label={ariaLabel}
    >
      <input
        id={toggleId}
        type="checkbox"
        className="wms-theme-day-night-switch__input"
        checked={checked}
        disabled={disabled}
      ...
      />
      <svg
        className="wms-theme-day-night-switch__svg"
        viewBox="0 0 69.667 44"
        xmlns="http://www.w3.org/2000/svg"
        aria-hidden
      >
        <defs>
          <filter id={filterContainerId} x="-20%" y="-20%" width="140%" height="140%">
            <feDropShadow dx="0" dy="2" stdDeviation="2" floodOpacity="0.18" />
          </filter>
          <filter id={filterSunOuterId} x="-30%" y="-30%" width="160%" height="160%">
            <feDropShadow dx="0" dy="1" stdDeviation="2" floodColor="#f8e664" floodOpacity="0.55" />
          </filter>
          <filter id={filterSunId} x="-20%" y="-20%" width="140%" height="140%">
            <feGaussianBlur stdDeviation="0.4" />
          </filter>
          <filter id={filterMoonId} x="-30%" y="-30%" width="160%" height="160%">
            <feDropShadow dx="0" dy="1" stdDeviation="2" floodColor="#cce6ee" floodOpacity="0.45" />
          </filter>
          <filter id={filterCloudId} x="-20%" y="-20%" width="140%" height="140%">
            <feDropShadow dx="0" dy="1" stdDeviation="1" floodOpacity="0.2" />
          </filter>
        </defs>
        <g transform="translate(3.5 3.5)">
          <g filter={`url(#${filterContainerId})`} transform="matrix(1, 0, 0, 1, -3.5, -3.5)">
            <rect
              className="wms-theme-day-night-switch__container"
              fill="#83cbd8"
          ...
          <g className="wms-theme-day-night-switch__button">
            <g className="wms-theme-day-night-switch__sun">
              <g filter={`url(#${filterSunOuterId})`} transform="matrix(1, 0, 0, 1, -5.83, -5.83)">
                <circle
                  fill="#f8e664"
              ...
              <g filter={`url(#${filterSunId})`} transform="matrix(1, 0, 0, 1, -5.83, -5.83)">
                <path
            ...
            <g className="wms-theme-day-night-switch__moon">
              <g filter={`url(#${filterMoonId})`} transform="matrix(1, 0, 0, 1, -31.5, -5.83)">
                <circle
                  fill="#cce6ee"
              ...
              <g
                ...
                className="wms-theme-day-night-switch__patches"
              >
          ...
          <g filter={`url(#${filterCloudId})`} transform="matrix(1, 0, 0, 1, -3.5, -3.5)">
            <path
              className="wms-theme-day-night-switch__cloud"
              fill="#fff"
          ...
          <g
            ...
            className="wms-theme-day-night-switch__stars"
          >
            <path

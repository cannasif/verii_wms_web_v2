...
const filterLocalGrid=<T extends {id:number}>(items:T[],request:GridRequest,searchableKeys:string[])=>
  filterLocalGridPage(items,request,searchableKeys,{paginate:false});

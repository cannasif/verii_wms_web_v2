...
async function buildAutoCompleteProductionTransferPayload(
  ...
  try {
    const defaultTarget = await productionTransferApi.defaultTargetLocation(workOrder.targetWarehouseId, branchCode);
  ...
  return {
    ...
    lineContexts: preparedLines.map((line, lineIndex) => ({
      lineIndex,
      lineRole: 'ConsumptionSupply',
      productionConsumptionId: null,
      productionOutputId: null,
      requirementReference: workOrder.workOrderNumber,

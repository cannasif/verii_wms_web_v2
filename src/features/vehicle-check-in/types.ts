...
export interface VehicleCheckInRow {
  ...
  carrierName?:string;customerId?:number;customerCode?:string;customerName?:string;checkedInAtUtc:string;businessDate:string;
...
export interface SaveVehicleCheckInRequest {
  ...
  carrierName?:string;customerId?:number;note?:string;
}

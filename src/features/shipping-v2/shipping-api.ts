...
export const shippingApi={
 ...
 cancel:async(id:number,reason:string):Promise<ShipmentOperationResult>=>unwrap(await api.post(`/api/shipments/${id}/cancel`,{idempotencyKey:crypto.randomUUID(),reason:reason.trim()})),

...
export interface GoodsReceiptDetail { header: GoodsReceiptGridRow; lines: GoodsReceiptDetailLine[]; putawayCandidates: GoodsReceiptPutawayCandidate[]; sourceDocuments: string[]; taskNumbers: string[]; executionCount: number; routes?: GoodsReceiptRoutingResult[] }

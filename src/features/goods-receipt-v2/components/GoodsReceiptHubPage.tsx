...
const phases=[
  {number:'01',title:'Kabulü Başlat',description:'Belgenin kaynağına ve operasyon şekline göre doğru başlangıcı seçin.',items:[
    {title:'Siparişten Emir',description:'Netsis satınalma siparişlerini seçin, açık miktarları rezerve edip görev oluşturun.',href:'/warehouse/goods-receipts/new',icon:ClipboardList},
    {title:'Siparişsiz Emir',description:'İrsaliye ve stok satırlarıyla sipariş bağlantısız planlı görev açın.',href:'/warehouse/goods-receipts/orderless',icon:PackagePlus},
    {title:'Doğrudan Mal Kabul',description:'Emirsiz kabulü kalite, karantina ve stok hareketiyle atomik kaydedin.',href:'/warehouse/goods-receipts/direct',icon:PackageCheck},
  ]},
  {number:'02',title:'Emri Yürüt',description:'Sorumluları belirleyin, atanan işleri alın ve fiziksel ilerlemeyi yönetin.',items:[
    {title:'Emir Yönetimi',description:'Açık emirleri bir veya birden çok kullanıcıya atayın ve ilerlemeyi izleyin.',href:'/warehouse/goods-receipts/tasks',icon:UsersRound},
    {title:'Bana Atanan Emirler',description:'Size atanmış emirleri kabul edin, başlatın ve operasyonu tamamlayın.',href:'/warehouse/goods-receipts/assigned',icon:UserCheck},
  ]},
  {number:'03',title:'İzle ve Yönet',description:'Tam izlenebilirlik ve parametrik süreç yönetimi için kayıtları ve kuralları kullanın.',items:[
    {title:'Mal Kabul Kayıtları',description:'Tüm işlem tiplerini ortak sunucu taraflı grid üzerinde izleyin.',href:'/warehouse/goods-receipts/list',icon:Rows3},
    {title:'Süreç Ayarları',description:'Fazla/eksik kabul, kalite bekletme, onay ve ERP aktarım politikalarını yönetin.',href:'/warehouse/goods-receipt-settings',icon:Settings2},
  ]},
];

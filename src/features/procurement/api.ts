...
export const procurementApi={
  ...
  updatePolicy:async(payload:Omit<ProcurementPolicy,'id'|'branchCode'|'updatedBy'|'updatedDate'>):Promise<ProcurementPolicy>=>unwrap(await api.put<Envelope<ProcurementPolicy>>('/api/procurement/policy',payload)),

...
export const PATH_TO_PERMISSION_PATTERNS: Array<{ pattern: RegExp; permission: string }> = [
  ...
  { pattern: /^\/warehouse\/production-transfers\/task-pool(\/|$)/, permission: 'WMS.PRODUCTION_TRANSFER.ASSIGN' },
  { pattern: /^\/warehouse\/production-transfers\/settings(\/|$)/, permission: 'WMS.PRODUCTION_TRANSFER.SETTINGS.VIEW' },
  { pattern: /^\/warehouse\/production-transfers\/material-requests(\/|$)/, permission: 'WMS.KKD.DISTRIBUTION.OPERATE' },
  { pattern: /^\/warehouse\/kkd\/requests\/\d+\/preparation-tasks\/\d+\/pick(\/|$)/, permission: 'WMS.KKD.REQUESTS.RESOLVE' },
  { pattern: /^\/warehouse\/kkd\/requests(\/|$)/, permission: 'WMS.KKD.REQUESTS.VIEW' },
  { pattern: /^\/warehouse\/kkd\/distributions\/new(\/|$)/, permission: 'WMS.KKD.DISTRIBUTION.OPERATE' },
  { pattern: /^\/warehouse\/kkd\/distributions(\/|$)/, permission: 'WMS.KKD.DISTRIBUTION.OPERATE' },
  { pattern: /^\/warehouse\/kkd\/definitions(\/|$)/, permission: 'WMS.KKD.DEFINITIONS.VIEW' },
  { pattern: /^\/warehouse\/kkd\/entitlement(\/|$)/, permission: 'WMS.KKD.ENTITLEMENT.CHECK' },
  { pattern: /^\/warehouse\/kkd\/reports(\/|$)/, permission: 'WMS.KKD.REPORTS.VIEW' },
  { pattern: /^\/warehouse\/kkd\/policy(\/|$)/, permission: 'WMS.KKD.POLICY.VIEW' },
  { pattern: /^\/warehouse\/kkd(\/|$)/, permission: 'WMS.KKD.DEFINITIONS.VIEW' },
  { pattern: /^\/warehouse\/process-parameters\/kkd-policy(\/|$)/, permission: 'WMS.KKD.POLICY.VIEW' },
  { pattern: /^\/warehouse\/production-transfers\/new(\/|$)/, permission: 'WMS.PRODUCTION_TRANSFER.CREATE' },
  { pattern: /^\/warehouse\/production-transfers(\/|$)/, permission: 'WMS.PRODUCTION_TRANSFER.VIEW' },

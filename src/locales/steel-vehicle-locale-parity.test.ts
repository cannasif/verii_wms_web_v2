...
const requiredKeys=[
  ...
  'vehicleCheckIn.status.CheckedIn',
  'vehicleCheckIn.status.LinkedToReceipt',
  'vehicleCheckIn.status.Completed',
  'vehicleCheckIn.status.Cancelled',
  'vehicleCheckIn.status.ContainsUnknownPlates',

...
export const DEFAULT_PROJECT_SETTINGS:ProjectSettings={id:0,numberLocale:'tr-TR',decimalPlaces:2,dateFormat:'dd.MM.yyyy',timeFormat:'HH:mm',yearFormat:'yyyy',timeZoneId:'Europe/Istanbul',sendSerialsToErp:true,passwordMinimumLength:6,passwordMaximumLength:15};
...
export function normalizeProjectSettings(value?:Partial<ProjectSettings>|null):ProjectSettings{return{
  ...
  passwordMinimumLength:Number.isInteger(value?.passwordMinimumLength)?Math.min(15,Math.max(5,value!.passwordMinimumLength!)):6,

...
} from "./chunk-TYH5R4AM.js";
import {
  require_shim
} from "./chunk-SIXYYJLJ.js";
import {
  Root as Root5,
  VisuallyHidden,
  clamp,
...
} from "./chunk-UWUKGRY3.js";
import {
  createCollection,
  createCollection2,
  dist_exports as dist_exports3,
  useDirection
} from "./chunk-GSJ5HBJI.js";
import {
  Anchor,
  Arrow,
  Content as Content2,
  ...
  createPopperScope,
  useSize
} from "./chunk-5ELODDCL.js";
import {
  Presence
} from "./chunk-5HL6XFSL.js";
import {
  Branch,
  DismissableLayer,
  Portal,
  ...
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime23.jsx)(
      SliderProvider,
      {
        ...
        orientation,
        form,
        children: (0, import_jsx_runtime23.jsx)(Collection5.Provider, { scope: props.__scopeSlider, children: (0, import_jsx_runtime23.jsx)(Collection5.Slot, { scope: props.__scopeSlider, children: (0, import_jsx_runtime23.jsx)(
          SliderOrientation,
          {
  ...
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime23.jsxs)(
      "span",
      {
        ...
        children: [
          (0, import_jsx_runtime23.jsx)(Collection5.ItemSlot, { scope: props.__scopeSlider, children: (0, import_jsx_runtime23.jsx)(
            Primitive.span,
            {
              role: "slider",
...
function createSlot2(ownerName) {
  ...
  const Slot22 = React25.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime24.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React25.isValidElement(newElement) ? React25.cloneElement(newElement, void 0, newChildren) : null });
    }
...
var ToastProvider = (props) => {
  ...
  return (0, import_jsx_runtime27.jsx)(Collection6.Provider, { scope: __scopeToast, children: (0, import_jsx_runtime27.jsx)(
    ...
    return (0, import_jsx_runtime27.jsxs)(
      Branch,
      {
        ...
        children: [
          ...
          (0, import_jsx_runtime27.jsx)(Collection6.Slot, { scope: __scopeToast, children: (0, import_jsx_runtime27.jsx)(Primitive.ol, { tabIndex: -1, ...viewportProps, ref: composedRefs }) }),
          hasToasts && (0, import_jsx_runtime27.jsx)(
            FocusProxy,
            {
  ...
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime27.jsxs)(import_jsx_runtime27.Fragment, { children: [
      ...
      (0, import_jsx_runtime27.jsx)(ToastInteractiveProvider, { scope: __scopeToast, onClose: handleClose, children: ReactDOM2.createPortal(
        (0, import_jsx_runtime27.jsx)(Collection6.ItemSlot, { scope: __scopeToast, children: (0, import_jsx_runtime27.jsx)(
          Root2,
          {
            asChild: true,
...
var Separator4 = React31.forwardRef((props, forwardedRef) => {
...
var Toolbar = React32.forwardRef(
  (props, forwardedRef) => {
    ...
    const direction = useDirection(dir);
    return (0, import_jsx_runtime31.jsx)(ToolbarProvider, { scope: __scopeToolbar, orientation, dir: direction, children: (0, import_jsx_runtime31.jsx)(
      Root4,
      {
        asChild: true,
        ...rovingFocusGroupScope,
...
var ToolbarButton = React32.forwardRef(
  (props, forwardedRef) => {
    ...
    const rovingFocusGroupScope = useRovingFocusGroupScope6(__scopeToolbar);
    return (0, import_jsx_runtime31.jsx)(Item, { asChild: true, ...rovingFocusGroupScope, focusable: !props.disabled, children: (0, import_jsx_runtime31.jsx)(Primitive.button, { type: "button", ...buttonProps, ref: forwardedRef }) });
  }
);
...
var ToolbarLink = React32.forwardRef(
  (props, forwardedRef) => {
    ...
    const rovingFocusGroupScope = useRovingFocusGroupScope6(__scopeToolbar);
    return (0, import_jsx_runtime31.jsx)(Item, { asChild: true, ...rovingFocusGroupScope, focusable: true, children: (0, import_jsx_runtime31.jsx)(
      Primitive.a,
      {
        ...linkProps,
        ref: forwardedRef,
...
var ToolbarToggleItem = React32.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime31.jsx)(ToolbarButton, { asChild: true, ...scope, children: (0, import_jsx_runtime31.jsx)(Item24, { ...toggleGroupScope, ...toggleItemProps, ref: forwardedRef }) });
  }
);
...
function createSlot3(ownerName) {
  ...
  const Slot22 = React33.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime32.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React33.isValidElement(newElement) ? React33.cloneElement(newElement, void 0, newChildren) : null });
    }
    return (0, import_jsx_runtime32.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children });
  });
  Slot22.displayName = `${ownerName}.Slot`;
  return Slot22;
}
...
function createSlottable3(ownerName) {
  const Slottable22 = ({ children }) => {
    return (0, import_jsx_runtime32.jsx)(import_jsx_runtime32.Fragment, { children });
  };
  Slottable22.displayName = `${ownerName}.Slottable`;
...
function isSlottable3(child) {
  return React33.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER3;
}
...
var [PortalProvider2, usePortalContext2] = createTooltipContext(PORTAL_NAME5, {
  forceMount: void 0
});
var TooltipPortal = (props) => {
  const { __scopeTooltip, forceMount, children, container } = props;
  const context = useTooltipContext(PORTAL_NAME5, __scopeTooltip);
  return (0, import_jsx_runtime33.jsx)(PortalProvider2, { scope: __scopeTooltip, forceMount, children: (0, import_jsx_runtime33.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime33.jsx)(Portal, { asChild: true, container, children }) }) });
};
TooltipPortal.displayName = PORTAL_NAME5;
var CONTENT_NAME9 = "TooltipContent";
var TooltipContent = React34.forwardRef(
  (props, forwardedRef) => {
    const portalContext = usePortalContext2(CONTENT_NAME9, props.__scopeTooltip);
      ...
      DismissableLayer,
      {
        ...
        children: (0, import_jsx_runtime33.jsxs)(
          Content2,
          {
            ...
            children: [
              (0, import_jsx_runtime33.jsx)(Slottable5, { children }),
              (0, import_jsx_runtime33.jsx)(VisuallyHiddenContentContextProvider, { scope: __scopeTooltip, isInside: true, children: (0, import_jsx_runtime33.jsx)(Root5, { id: context.contentId, role: "tooltip", children: ariaLabel || children }) })
            ]
          }
        )
      }
